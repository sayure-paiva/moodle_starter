...
class quiz_attempt {
    ...
    public function get_navigation_panel(mod_quiz_renderer $output,
        ...
        $card_estudante = is_siteadmin($USER) ? '' : 'card_estudante'; //verifica se o usuário é estudante para alterar a classe abaixo.
        $bc->add_class($card_estudante); //aqui chamo o resultado do ternário
