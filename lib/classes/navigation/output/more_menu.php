...
class more_menu implements renderable, templatable
{
    ...
    public function export_for_template(renderer_base $output): array
    {
        ...
        /* 
        Condição que verifica se o usuário é administrador 
        Se for mostra os menus Página Inicial, Meus Cursos e Administração.
        Qualquer outro papel não carrega os links.
        */
        global $USER;
