...
class core_user_renderer extends plugin_renderer_base
{
    ...
    public function user_profile_card($user)
    {
        // Aqui você cria o código HTML para exibir o perfil do usuário
        // $user é um objeto contendo os detalhes do usuário, incluindo nome, sobrenome, email e avatar.
        $output = '<div class="user-profile-card">';
        echo '<div class="user-profile-card">';
        echo '<div class="avatar">';
        // Verifica se o usuário possui uma imagem de perfil personalizada
        if ($user->profileimageurl) {
            $output .= '<img src="' . $user->profileimageurl . '" alt="Avatar">';
        } else {
            // Caso o usuário não tenha uma imagem personalizada, exibe o avatar padrão
            $output .= $this->output->user_picture($user, array('size' => 100));
        }
        echo '</div>';
        echo '<div class="user-info">';
        echo '<p><strong>Nome:</strong>' . $user->firstname . '</p>';
