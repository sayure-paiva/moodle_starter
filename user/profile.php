...
//verifica o perfil e insere a class css adequada
$userprofile = has_capability('mod/folder:managefiles', context_system::instance()) ? '' : 'userprofile-estudante';
echo $OUTPUT->header();
echo '<div class="userprofile '.$userprofile.'">';
