...
class renderer extends \plugin_renderer_base {
    ...
    public function render_tree(tree $tree) {
        ...
        foreach ($categories as $category) {
            if($category->name !== 'privacyandpolicies' && $category->name !== 'reports') { // condição que remove as politicas e os relatórios na tela de perfil.
    ...
    public function render_category(category $category) {
        ...
        foreach ($nodes as $node) { 
            if ($node->name !== 'timezone' && $node->name !== 'blogs') { //condição que remove timezone e blogs
    ...
    public function render_node(node $node) {
        ...
        if (!empty($content)) {
            ...
            if ($classes) {
                ...
                if ($node->name === 'courseprofiles') {
                    $return = \html_writer::tag('li', $return, array('class' => 'contentnode my-profile-course'));
                } else {
